  ...
  <div class="max-w-300 mx-auto">
    ...
    <div class="prose pb5 mx-auto mt10 text-center">
      <div flex="~ gap-2 justify-center">
        <a
          href="https://github.com/phungmanhquang"
          target="_blank"
        ...
        <a
          href="https://releases.quangphung.site"
          target="_blank"
        ...
        <a
          href="https://yak.quangphung.site"
          target="_blank"
    ...
    <div class="prose pb5 mx-auto mt10 text-center">
      <div block mt-5>
        <a href="https://quangphung.site/stars-rank" target="_blank" op50>All projects sort by Stars</a>
      </div>
      <hr>
      <SponsorButtons />
    </div>
