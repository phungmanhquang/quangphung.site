...
const base = 'https://quangphung.site'
const tweetUrl = computed(() => `https://twitter.com/intent/tweet?text=${encodeURIComponent(`Reading @phungmanquang\'s ${base}${route.path}\n\nI think...`)}`)
